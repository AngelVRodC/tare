...
func TestMeasureDeliveredContent(t *testing.T) {
	for _, tc := range []struct {
		...
		{"wrapped string body", `{"body":"abc","success":true}`, Content{}},
		{"wrapped block body", `{"body":[{"type":"input_text","text":"abc"}],"success":false}`, Content{}},
		{"output_text block", `[{"type":"output_text","text":"abc"}]`, Content{}},
		{"null", ` null `, Content{}},
		{"absent", ``, Content{}},
